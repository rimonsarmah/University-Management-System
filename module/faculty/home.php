...
<a class="active" href="applyleave.php" target="iframe_a">Apply Leave</a>
<a class="active" href="viewleave.php" target="iframe_a">View Your Leave</a>
  ...
  <div class="rightcolumn">
    ...
    <center>
      ...
      <?php echo $string;?><br>
        ...
        <br>
        Subject: <?php echo ucfirst($stream);?>
        <br>
    ...
    <div class="card">
      ...
      <p>Dear Faculty! Do attend the conference on Audiotriam sharply at 12:00 PM.</p>
    </div>
  </div>
</div>
