...
<div align="center"><h1>Jawahar Navodaya Vidyalaya Golaghat</h1></div>
        ...
        <center>
            ...
            <form action="#" method="post"onsubmit="return newStudentValidation();" enctype="multipart/form-data">
                        ...
                        <label for="stuID">Admission No:</label>
                        <input id="admNo" type="text" name="admissionNo" placeholder="Enter Admission No to be deleted">
...
if(!empty($_POST['submit'])){
    ...
    $sql = "DELETE FROM bio where admissionno='$admNo';";
    $success = mysqli_query($link,$sql);
    echo "Successfully deleted student with ID number '$admNo' and all his data";
    if(!$success) {
